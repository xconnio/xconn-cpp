...
Authenticator::Authenticator(std::string auth_id, std::string auth_data, Dict auth_extra)
    : auth_id(std::move(auth_id)), auth_data(std::move(auth_data)), auth_extra(std::move(auth_extra)) {}

AnonymousAuthenticator::AnonymousAuthenticator(std::string auth_id, Dict auth_extra)
...
TicketAuthenticator::TicketAuthenticator(std::string auth_id, std::string ticket, Dict auth_extra)
...
CryptosignAuthenticator::CryptosignAuthenticator(std::string auth_id, std::string private_key_hex, Dict auth_extra)
...
WAMPCRAAuthenticator::WAMPCRAAuthenticator(std::string auth_id, std::string secret, Dict auth_extra)
